...
function ActionSearchBar({ actions = allActions, className, isOpen, onClose }: { actions?: Action[], className?: string, isOpen?: boolean, onClose?: () => void }) {
    ...
    }, [debouncedQuery, isFocused, isOpen])
    ...
    return (
        ...
        <div className="relative flex flex-col justify-start items-center">
                <div className="w-full max-w-sm sticky top-0 z-10 pt-4 pb-1" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="relative">
                        <Input
                            ...
                            className="pl-3 pr-40 py-1.5 h-9 text-sm rounded-lg focus-visible:ring-offset-0"
                        />
